...
router.get('/borough/:borough/:weather', function(req, res) {
  ...
  if (weather == 'Snow') {
    ...
    //still 
    query = 'select * from (select count(distinct t.tripId)*500*24/case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end as snow_p from CIS550.Trip t inner join (select * from CIS550.Weather w where snowfall > 0.2) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.puId = p.locationId where borough = \'' + borough + '\') as snowp, (select count(distinct t.tripId)*500*24/case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end as snow_d from CIS550.Trip t inner join (select * from CIS550.Weather w where snowfall > 0.2) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.dropId = p.locationId where borough = \'' + borough + '\') as snowd, (select count(distinct t.tripId)*24*500*100 / (b.population * case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end) as snow_ppc from CIS550.Borough b, CIS550.Trip t inner join (select * from CIS550.Weather w where snowfall > 0.2) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.puId = p.locationId where p.borough = \'' + borough + '\' and b.name = \'' + borough + '\') as snowppc, (select count(distinct t.tripId)*24*500*100 / (b.population * case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end) as snow_dpc from CIS550.Borough b, CIS550.Trip t inner join (select * from CIS550.Weather w where snowfall > 0.2) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.dropId = p.locationId where p.borough = \'' + borough + '\' and b.name = \'' + borough + '\') as snowdpc';
  } else if (weather == 'Rain') {
    query = 'select * from (select count(distinct t.tripId)*500*24/case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end as rain_p from CIS550.Trip t inner join (select * from CIS550.Weather w where precipitation - snowfall > 0.1) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.puId = p.locationId where borough = \'' + borough + '\') as rainp, (select count(distinct t.tripId)*500*24/case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end as rain_d from CIS550.Trip t inner join (select * from CIS550.Weather w where precipitation - snowfall > 0.1) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.dropId = p.locationId where borough = \'' + borough + '\') as raind, (select count(distinct t.tripId)*24*500*100 / (b.population * case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end) as rain_ppc from CIS550.Borough b, CIS550.Trip t inner join (select * from CIS550.Weather w where precipitation - snowfall > 0.1) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.puId = p.locationId where p.borough = \'' + borough + '\' and b.name = \'' + borough + '\') as rainppc, (select count(distinct t.tripId)*24*500*100 / (b.population * case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end) as rain_dpc from CIS550.Borough b, CIS550.Trip t inner join (select * from CIS550.Weather w where precipitation - snowfall > 0.1) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.dropId = p.locationId where p.borough = \'' + borough + '\' and b.name = \'' + borough + '\') as raindpc';
  } else if (weather == 'Hot') {
    query = 'select * from (select count(distinct t.tripId)*500*24/case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end as hot_p from CIS550.Trip t inner join (select * from CIS550.Weather w where temp > 80) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.puId = p.locationId where borough = \'' + borough + '\') as hotp, (select count(distinct t.tripId)*500*24/case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end as hot_d from CIS550.Trip t inner join (select * from CIS550.Weather w where temp > 80) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.dropId = p.locationId where borough = \'' + borough + '\') as hotd, (select count(distinct t.tripId)*24*500*100 / (b.population * case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end) as hot_ppc from CIS550.Borough b, CIS550.Trip t inner join (select * from CIS550.Weather w where temp > 80) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.puId = p.locationId where p.borough = \'' + borough + '\' and b.name = \'' + borough + '\') as hotppc, (select count(distinct t.tripId)*24*500*100 / (b.population * case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end) as hot_dpc from CIS550.Borough b, CIS550.Trip t inner join (select * from CIS550.Weather w where temp > 80) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.dropId = p.locationId where p.borough = \'' + borough + '\' and b.name = \'' + borough + '\') as hotdpc';
  } else if (weather == 'Cold') {
    query = 'select * from (select count(distinct t.tripId)*500*24/case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end as cold_p from CIS550.Trip t inner join (select * from CIS550.Weather w where temp < 30) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.puId = p.locationId where borough = \'' + borough + '\') as coldp, (select count(distinct t.tripId)*500*24/case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end as cold_d from CIS550.Trip t inner join (select * from CIS550.Weather w where temp < 30) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.dropId = p.locationId where borough = \'' + borough + '\') as coldd, (select count(distinct t.tripId)*24*500*100 / (b.population * case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end) as cold_ppc from CIS550.Borough b, CIS550.Trip t inner join (select * from CIS550.Weather w where temp < 30) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.puId = p.locationId where p.borough = \'' + borough + '\' and b.name = \'' + borough + '\') as coldppc, (select count(distinct t.tripId)*24*500*100 / (b.population * case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end) as cold_dpc from CIS550.Borough b, CIS550.Trip t inner join (select * from CIS550.Weather w where temp < 30) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.dropId = p.locationId where p.borough = \'' + borough + '\' and b.name = \'' + borough + '\') as colddpc';
  } else if (weather == 'Windy') {
    query = 'select * from (select count(distinct t.tripId)*500*24/case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end as wind_p from CIS550.Trip t inner join (select * from CIS550.Weather w where wind > 25) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.puId = p.locationId where borough = \'' + borough + '\') as windp, (select count(distinct t.tripId)*500*24/case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end as wind_d from CIS550.Trip t inner join (select * from CIS550.Weather w where wind > 25) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.dropId = p.locationId where borough = \'' + borough + '\') as windd, (select count(distinct t.tripId)*24*500*100 / (b.population * case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end) as wind_ppc from CIS550.Borough b, CIS550.Trip t inner join (select * from CIS550.Weather w where wind > 25) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.puId = p.locationId where p.borough = \'' + borough + '\' and b.name = \'' + borough + '\') as windppc, (select count(distinct t.tripId)*24*500*100 / (b.population * case when count(distinct w1.d) = 0 then 1 else count(distinct w1.d) end) as wind_dpc from CIS550.Borough b, CIS550.Trip t inner join (select * from CIS550.Weather w where wind > 25) w1 on t.timePickup between w1.d and DATE_ADD(w1.d, INTERVAL 1 HOUR) left join CIS550.Place p on t.dropId = p.locationId where p.borough = \'' + borough + '\' and b.name = \'' + borough + '\') as winddpc';
  }
